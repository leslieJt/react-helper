...
test('proc cancellation: call effect', done => {
  expect.assertions(1)
  ...
  task.done.catch(err => done.fail(err))
...
test('proc cancellation: forked children', done => {
  expect.assertions(1)
...
test('proc cancellation: take effect', done => {
  expect.assertions(1)
...
test('proc cancellation: join effect (joining from a different task)', done => {
  expect.assertions(1)
...
test("proc cancellation: join effect (join from the same task's parent)", done => {
  expect.assertions(1)
...
test('proc cancellation: parallel effect', done => {
  expect.assertions(1)
...
test('proc cancellation: race effect', done => {
  expect.assertions(1)
...
test('proc cancellation: automatic parallel effect cancellation', done => {
  expect.assertions(1)
...
test('proc cancellation: automatic race competitor cancellation', done => {
  expect.assertions(1)
...
test('proc cancellation:  manual task cancellation', done => {
  expect.assertions(1)
...
test('proc cancellation: nested task cancellation', done => {
  expect.assertions(1)
...
test('proc cancellation: nested forked task cancellation', done => {
  expect.assertions(1)
...
test('cancel should be able to cancel multiple tasks', done => {
  expect.assertions(1)
...
test('cancel should support for self cancellation', done => {
  expect.assertions(1)
